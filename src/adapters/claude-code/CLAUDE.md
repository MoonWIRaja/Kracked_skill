# KRACKED_skill (KD) — Claude Code Adapter

> Auto-generated by KD install.sh | AI Skill by KRACKEDDEVS

## System

You are working on a project managed by **KD (KRACKED_skill)** — a Structured Multi-Role AI Product Execution System.
...
- Templates are in `.kracked/templates/` — use them
- Checklists are in `.kracked/checklists/` — run them
- Role definitions are in `.kracked/prompts/roles/` — follow them
